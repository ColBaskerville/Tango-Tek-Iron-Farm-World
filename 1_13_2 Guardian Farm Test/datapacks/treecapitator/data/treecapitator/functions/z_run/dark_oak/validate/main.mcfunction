...
function treecapitator:z_run/dark_oak/validate/loop
execute if score ValidTree TC_Value matches 1 run function treecapitator:z_run/dark_oak/validate/whenvalid