...
function treecapitator:z_run/acacia/validate/loop
execute if score ValidTree TC_Value matches 1 run function treecapitator:z_run/acacia/validate/whenvalid